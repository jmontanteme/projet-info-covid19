...
metadata_path = '/Users/juliettemontanteme/Desktop/metadata_processed_final.csv'
...
for j in range(len(meta_df)):
    ...
    try: 
        ...
        for i in range(13):
            ...
            d = sc.score_fr_doc
            meta_df[f'note_{columns[i]}'].iloc[j] = a + b + c + d    
...
meta_df.to_csv("metadata_scored_final.csv")